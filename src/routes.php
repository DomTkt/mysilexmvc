...
$app->get('/dogs/list', 'App\Dogs\Controller\IndexController::listAllAction')->bind('dogs.listall');
$app->get('/dogs/list/{maitre}', 'App\Dogs\Controller\IndexController::listByOwnerAction')->bind('dogs.listbyo');
